            ...
            <div className="container my-auto">
                <div className="row">
                    <div className="col-lg-10 mx-auto">
                        ...
                        <p className="mb-5">This is the third version of my portfolio, starting with a simple page with html and css and evolving into a single page react app currently.</p>
                        <p className="mb-5">When I am not working, I spend most of my time playing video games with my parrot, Kato.</p>
                    </div>
                </div>
            </div>
        </div>
